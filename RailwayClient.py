    ...
    def FRM1():
        ...
        def FRMS():
            ...
            def searchTBS(a1,a2):
                ...
                fin=open(r'C:/Users/ashis/OneDrive/Desktop\Assignments/Railway/STATION CODE.txt','r')
                abc=fin.read()
            ...
            def search(a1,a2):
                ...
                p=[]
                for m in TR:
                    path=r'C:/Users/ashis/OneDrive/Desktop/Assignments/Railway/TRAINS/%s.txt'%str(m)
                    fout=open(path,'r')
                    abc=fout.read()
        ...
        def FRMP():
            ...
            def check(a):
                a=a.get().strip()
                if a!='':
                    fin=open(r'C:/Users/ashis/OneDrive/Desktop/Assignments/Railway/PNRS.txt','r')
                    i=fin.readline()
                    while i:
                        p=i.strip('\n')
                        if a==i:
                    ...
                    lb.pack()
            def show(a):
                fin=open(r'C:/Users/ashis/OneDrive/Desktop/Assignments/Railway/PASSENGER.txt','r')
                i=fin.readline()
                while i:
                    ls=i.split(',')
                    if a==ls[0]:
        ...
        def FRMT():
            ...
            def getsch(a1,a2):
                a1=a1.get().strip().upper()
                a2=a2.get().strip().upper()
                fin=open(r'C:/Users/ashis/OneDrive/Desktop/Assignments/Railway/TRAIN CODE.txt','r')
                abc=fin.read()
                if a1 in abc or a2 in abc and (a1!='' or a2!=''):
                    ...
                    while i:
                        ...
                        if a1 == l[0] or a2 ==l[1]:
                            code=l[0]
                            path=r'C:/Users/ashis/OneDrive/Desktop/Assignments/Railway/TRAINS/%s.txt'%str(code)
                            fout=open(path,'r')
                            m=fout.readlines()
                    ...
                    if a8==''or a8 not in ['1A','2A','3A','SL']:
                        ...
                        if x[0][ind]>=p[ind]:
                            ...
                            while True:
                                ...
                                f=open(r'C:/Users/ashis/OneDrive/Desktop/Assignments/Railway/PNRS.txt','r')
                                if str(pnr) not in f.read():
                                    f.close()
                                    f=open(r'C:/Users/ashis/OneDrive/Desktop/Assignments/Railway/PNRS.txt','a')
                                    f.writelines('\n'+str(pnr))
                                    f.flush()
                                    break
                            fin=open(r'C:/Users/ashis/OneDrive/Desktop/Assignments/Railway/PASSENGER.txt','a')
                            txt=str(pnr)+','+a1+','+a2+','+a3+','+a4+','+a5+','+a6+','+a7+','
                            txt=txt+a8+','+a9+'-'+a10+'-'+a11+'\n'
                            fin.write(txt)
                            fin.close()
                            pth=r'C:/Users/ashis/OneDrive/Desktop/Assignments/Railway/TRAINS/%s.txt'%y
                            fin=open(pth,'r+')
                            f2=open(r'C:/Users/ashis/OneDrive/Desktop/Assignments/Railway/temp.txt','w')
                            i=fin.readline()
                            ctr=0
                            while i:
                            ...
                            f2.close()
                            os.remove(pth)
                            os.rename(r'C:/Users/ashis/OneDrive/Desktop/Assignments/Railway/temp.txt',pth)
...
w1.geometry(size)
ph=ImageTk.PhotoImage(Image.open('C:/Users/ashis/OneDrive/Desktop/Assignments/Railway/welcome.jpg'))
...
def pw_frame():
    ...
    btn.pack()
def check(a1,a2):
    fin=open(r'C:/Users/ashis/OneDrive/Desktop/Assignments/Railway/PASSWORD.txt')
    a1=a1.get()
    a2=a2.get()
